...
def predict_readers_two_level(file_path, max_entries_in_mht, max_lines_per_PHT, number_of_procs, count_thread_write_as_read = True):
    correct = 0
    incorrect = 0
    count = 0
...
if __name__ == "__main__":
    ...
    predict_readers_two_level(file_path, max_entries_in_mht, max_lines_per_PHT, number_of_procs, allow)
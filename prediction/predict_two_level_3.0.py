...
def predict_readers_two_level_update_MSR_2bit_PHT(file_path, max_entries_in_mht, max_lines_per_PHT, number_of_procs, count_thread_write_as_read = True):
    correct = 0
    incorrect = 0
    count = 0
    ...
    with open(file_path, 'r') as file:
        for line in file:
            ...
            if read_write == 'W':
                ...
                # TODO: Investigate len() here...
                if len(cache_writer_history) != 0:
                    pattern_tables.upgrade_index_by_pattern(cache_line, tuple(cache_writer_history), thread, True)
...
if __name__ == "__main__":
    ...
    predict_readers_two_level_update_MSR_2bit_PHT(file_path, max_entries_in_mht, max_lines_per_PHT, number_of_procs, allow)